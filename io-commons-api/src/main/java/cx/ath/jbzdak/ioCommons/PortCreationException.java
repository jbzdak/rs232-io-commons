 ...
 */
public class PortCreationException extends PortException{

   public PortCreationException() {
   }

   public PortCreationException(Throwable cause) {
      super(cause);
   }
   ...
   public PortCreationException(String message, Throwable cause) {
      super(message, cause);
   }
}
