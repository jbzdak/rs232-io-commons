...
public class TwoParametricPanel extends JPanel{
   ...
   private class ChartMaker{
      ...
      private void updateLegend(){
         ...
         frontend.addFrontendListener(new FrontendListener() {
            volatile boolean subtitleChanges = false;
            @Override
            public void onNewData(Object data) {
               if(!subtitleChanges){
                  try{
                     if(lastLegend != null){
                        chart.removeSubtitle(lastLegend);
                     }
                     ...
                     final PaintScaleLegend legend = new PaintScaleLegend(scale, legendAxis);
